...
class QrcodeServer
{
    ...
    public function __construct($config) {
        ...
        isset($config['name'])          &&  $this->_name            = $config['name'];
    }
    ...
    public function createServer($content) {
        ...
        if ($this->_generate == 'display') {
            ...
            $name = $this->_name;
            return $this->generateImg($file_name,$name);
        } else {
     ...
     * @return array
     */
    public function generateImg($file_name,$name) {
        $file_path = $file_name . DIRECTORY_SEPARATOR . $name . '.' . self::WRITE_NAME;
